...
/***/ "./resources/js/user/admin/menu/index.js":
/*!***********************************************!*\
  !*** ./resources/js/user/admin/menu/index.js ***!
  \***********************************************/
/*! no exports provided */
...
function initEditModal() {
  ...
  editBtns.forEach(function (btn) {
    btn.onclick = function (e) {
      axios.get(editForm.dataset.getMenu + '/' + btn.dataset.id).then(function (response) {
        ...
        editForm.querySelector('select[name=type]').selectedIndex = editForm.querySelector('select[name=type] option[value="' + response.data.data.type + '"]').index;
...
function initDeleteBtns() {
  var delBtns = document.querySelectorAll('#menu-list .btn-delete');
  delBtns.forEach(function (btn) {
    btn.onclick = function () {
      if (confirm('Bạn có chắc muốn xóa menu này?')) {
        axios.post(document.getElementById('menu-list').dataset.deleteMenu + '/' + btn.dataset.id, {
          _method: 'DELETE'
        }).then(function (response) {
...
/***/ 11:
/*!*****************************************************!*\
  !*** multi ./resources/js/user/admin/menu/index.js ***!
  \*****************************************************/
/*! no static exports found */
