...
function fillRoomUserModalFormData(data) {
  ...
  roomUsersModalForm.querySelector('input[name=birthday]').value = data.birthday || ''; // roomUsersModalForm.querySelector('input[name=career]').value = data.career || '';
...
function renderRoomUsersItem(data) {
  ...
  _userItem.querySelector('.list__user').setAttribute('data-birthday', data.birthday); // if (data.detail.career !== null) {
