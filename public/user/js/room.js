...
function initRoomImageUploader() {
  var uploaderInput = document.querySelector('#file-gallery');
  filepond__WEBPACK_IMPORTED_MODULE_0__["create"](uploaderInput, _TrovieHelper__WEBPACK_IMPORTED_MODULE_1__["TrovieHelper"].getOptionsForFIlepondInstance(uploaderInput));
}
...
function roomCardClickHandler() {
  var card = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document.querySelector('');

  if (_typeof(card) !== 'object') {
    return false;
  }
...
function initRoomTypeFilterHandler() {
  var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll('.panel-content--room__filter--room-type__item a')),
      _step2;
      ...
      el.addEventListener('click', function (e) {
        (function (el) {
          ...
          if (!_listRoomType.includes(filterRoomType)) {
            var _iterator3 = _createForOfIteratorHelper(_roomList),
                _step3;
...
module.exports = __webpack_require__(/*! /var/www/html/trovie/resources/js/user/room.js */"./resources/js/user/room.js");
