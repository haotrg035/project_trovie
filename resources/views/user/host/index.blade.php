                                ...
                                <div class="row row--custom">
                                    <div class="col-lg-4 col--custom">
                                        <div class="form-group">
                                            <label for="">Ngày Ghi Tiền Điện:</label>
                                            <input type="date" class="form-control trovie-input" name="payment_day"
                                                   id="payment_day" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col--custom">
                                        <div class="form-group">
                                            <label for="">Ngày Ghi Tiền Nước:</label>
                                            <input type="date" class="form-control trovie-input" name="payment_day"
                                                   id="payment_day" placeholder="">
                                        </div>
                                    </div>
...
@endsection
@section('script')
    <script src="{{mix(config('app.user_theme') .'/js/host.js')}}"></script>
@endsection
