    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content border-0">
            <x-main-card has-header="1">
                ...
                <form action="" class="add-room-modal__form">
                    <div class="row row--custom">
                        <div class="col-md-4">
                            <div class="form-group mb-lg-0">
                                <div class="trovie-gallery trovie-gallery--room mt-2">
                                    <input class="filepond" type="file" name="gallery"
                                           id="add-room-modal__form__file-gallery"
                                           multiple
                        ...
                        <div class="col-12 col--custom mb-0">
                            <div class="form-group d-flex justify-content-end mb-0 pt-3 border-top">
